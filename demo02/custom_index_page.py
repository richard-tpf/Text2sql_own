...
在 Vanna Agents 主页基础上添加两个知识库管理入口：
- 表结构知识库（/knowledge/schema）
- 业务文档知识库（/knowledge/business）
"""
...
<head>
    ...
    <title>数仓开发助手 - Vanna Agents</title>
    ...
    <style>
        ...
        vanna-chat {{ width: 100%; height: 100%; display: block; }}
    </style>
    {component_script}
</head>
<body>
    <div class="max-w-6xl mx-auto p-5">
        ...
        <div class="text-center mb-8">
            <h1 class="text-4xl font-bold text-vanna-navy mb-2 font-serif">📊 数仓开发助手</h1>
            <p class="text-lg font-mono font-bold text-vanna-teal mb-4">DWD → DWS → ADS</p>
            <p class="text-slate-600 mb-4">基于双知识库的数仓加工 SQL 开发助手</p>
            <div class="flex items-center justify-center gap-3">
                <a href="/knowledge/schema"
                   class="inline-flex items-center gap-2 px-5 py-2.5 bg-vanna-teal text-white text-sm font-medium rounded-lg hover:bg-vanna-navy transition shadow-md">
                    🗄️ 表结构知识库
                </a>
            ...
            <div class="flex items-center justify-center gap-3 mt-3">
                <a href="/api/templates/schema"
                   class="inline-flex items-center gap-1 px-4 py-2 border border-vanna-teal text-vanna-teal text-xs font-medium rounded-lg hover:bg-vanna-teal hover:text-white transition">
                    ⬇ 表结构导入模板
                </a>
                <a href="/api/templates/requirement"
                   class="inline-flex items-center gap-1 px-4 py-2 border border-vanna-orange text-vanna-orange text-xs font-medium rounded-lg hover:bg-vanna-orange hover:text-white transition">
                    ⬇ 需求文档模板
                </a>
                <a href="/api/templates/development"
                   class="inline-flex items-center gap-1 px-4 py-2 border border-vanna-navy text-vanna-navy text-xs font-medium rounded-lg hover:bg-vanna-navy hover:text-white transition">
                    ⬇ 开发文档模板
                </a>
            </div>
        </div>
        ...
        <div id="loginContainer" class="max-w-md mx-auto mb-10 bg-white p-8 rounded-xl shadow-lg border border-vanna-teal/30">
            ...
            <div class="mb-5">
                ...
                <select id="emailInput"
                        class="w-full px-4 py-3 text-sm border border-vanna-teal/30 rounded-lg focus:outline-none focus:ring-2 focus:ring-vanna-teal bg-white">
            ...
            <button id="loginButton"
                    class="w-full px-4 py-3 bg-vanna-teal text-white text-sm font-medium rounded-lg hover:bg-vanna-navy transition">
                继续
            </button>
        </div>
        ...
        <div id="loggedInStatus" class="hidden text-center p-4 bg-vanna-teal/10 border border-vanna-teal/30 rounded-lg mb-5">
            ...
            <br>
            <button id="logoutButton" class="mt-2 px-3 py-1.5 bg-vanna-navy text-white text-xs rounded hover:bg-vanna-teal transition">退出登录</button>
        </div>
        ...
        <div id="chatSections" class="hidden">
            ...
            <div class="mt-8 p-5 bg-white rounded-lg shadow border border-vanna-teal/30">
                ...
                <ul class="space-y-2">
                    ...
                    <li class="p-2 bg-vanna-cream/50 rounded font-mono text-sm">
                        <span class="font-bold text-vanna-orange mr-2">POST</span>{api_base_url}/api/knowledge/schema/upload - 上传表结构知识
                    </li>
                    <li class="p-2 bg-vanna-cream/50 rounded font-mono text-sm">
                        <span class="font-bold text-vanna-orange mr-2">POST</span>{api_base_url}/api/knowledge/business/upload - 上传业务文档知识
                    </li>
                    <li class="p-2 bg-vanna-cream/50 rounded font-mono text-sm">
                        <span class="font-bold text-vanna-teal mr-2">GET</span>/knowledge/schema - 表结构知识管理
                    </li>
                    <li class="p-2 bg-vanna-cream/50 rounded font-mono text-sm">
                        <span class="font-bold text-vanna-teal mr-2">GET</span>/knowledge/business - 业务文档知识管理
                    </li>
                </ul>
            </div>
        </div>

...
from demo03.DWSystemPromptBuilder import DWSystemPromptBuilder
from demo03.LoggingLifecycleHook import LoggingLifecycleHook
from demo03.LoggingLlmMiddleware import LoggingLlmMiddleware
from demo03.LoggingObservabilityProvider import LoggingObservabilityProvider
from demo03.NoOpAgentMemory import NoOpAgentMemory
from demo03.knowledge_base import DualKnowledgeBaseManager
from demo03.knowledge_tools import SaveKnowledgeTool, SearchKnowledgeTool
from demo03.requirement_parser_tool import ParseRequirementDocTool
from demo03.generate_dws_sql_tool import GenerateDwsSqlTool
from demo03.generate_ads_sql_tool import GenerateAdsSqlTool
from demo03.TaskTitlePresearchWorkflowHandler import TaskTitlePresearchWorkflowHandler
from demo03.TimeoutLlmService import TimeoutLlmService
...
# 注册 DWS 层 SQL 生成工具
tools.register_local_tool(GenerateDwsSqlTool(), access_groups=['admin', 'user'])
# 注册 ADS 层 SQL 生成工具
tools.register_local_tool(GenerateAdsSqlTool(), access_groups=['admin', 'user'])
...
from demo03.schema_upload_page import get_schema_upload_html
from demo03.business_upload_page import get_business_upload_html
from demo03.custom_index_page import get_custom_index_html
